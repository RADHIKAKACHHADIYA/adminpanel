...
function AddPatient({ openprops, handleClose, edit }) {
    ...
    let AddSchema = {
        ...
        number: yup.string()
            .required("number is must be requrired"),
        age: yup.string()
            .required("age is must be requrired"),
        date: yup.string()
            .required("date is must be requrired"),
        city: yup.string()
            .required("city is must be requrired"),
    };
